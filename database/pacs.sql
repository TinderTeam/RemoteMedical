...
INSERT INTO `pacs`.`misp_system_menu` VALUES ('1','个人信息','个人信息',NULL,NULL,NULL,NULL,NULL,'0','1'),('10','诊断统计','诊断统计',NULL,NULL,NULL,NULL,'report/ReportManage','9','10'),('11','费用统计','费用统计',NULL,NULL,NULL,NULL,'report/ReportManage!costCount.action','9','11'),('12','日志管理','日志管理',NULL,NULL,NULL,NULL,NULL,'0','12'),('13','操作日志','操作日志',NULL,NULL,NULL,NULL,'log/LogManage','12','13'),('14','我的首页','我的首页',NULL,NULL,NULL,NULL,'user/UserManage!home.action','1','14'),('15','工作量统计','工作量统计',NULL,NULL,NULL,NULL,'report/ReportManage!workCount.action','9','15'),('2','专家信息','专家信息',NULL,NULL,NULL,NULL,'ExpertManage!infoEdit.action','1','2'),('3','医院信息','医院信息',NULL,NULL,NULL,NULL,'HospitalManage!infoEdit.action','1','3'),('4','用户管理','用户管理',NULL,NULL,NULL,NULL,NULL,'0','4'),('5','系统用户','系统用户',NULL,NULL,NULL,NULL,'user/UserManage','4','5'),('6','审核管理','审核管理',NULL,NULL,NULL,NULL,'user/ApprovalManage','4','6'),('7','专家管理','专家管理',NULL,NULL,NULL,NULL,'user/ExpertManage','4','7'),('8','医院管理','医院管理',NULL,NULL,NULL,NULL,'user/HospitalManage','4','8'),('9','统计信息','统计信息',NULL,NULL,NULL,NULL,NULL,'0','9');
