/**   
* @Title: OperLogConsant.java 
* @Package cn.fuego.misp.constant 
* @Description: TODO
* @author Tang Jun   
* @date 2014-10-8 上午09:54:36 
* @version V1.0   
*/ 
package cn.fuego.misp.constant;

/** 
 * @ClassName: OperLogConsant 
 * @Description: TODO
 * @author Tang Jun
 * @date 2014-10-8 上午09:54:36 
 *  
...
public class MISPOperLogConsant
{
	...
	public static final String MODIFY_APPLY="提交修改申请";
